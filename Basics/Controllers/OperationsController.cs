...
namespace Basics.Controllers
{
    public class OperationsController : Controller
    {
        ...
        {
            var coockieJar = new CookieJar();//get from db
          
            await _authorizationService.AuthorizeAsync(User, coockieJar, CookieJarAuthOperations.Open);
            return View();
        }
    }

    public class CookieJarOperationsHandler :
